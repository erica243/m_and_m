...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=orders" class="nav-item nav-orders"><span class='icon-field'><i class="fas fa-box"></i></span> Orders</a>
				...
				<a href="index.php?page=reports" class="nav-item nav-reports"><span class='icon-field'><i class="fa fa-chart-line"></i></span> Reports</a>
