...
<body>
    ...
    <div class="col-md-6">
        ...
        <canvas id="salesByProductChart" style="width: 100%; height: 400px;"></canvas>
    </div>

    <!-- Bar Chart -->
    <div class="col-md-6">
        <h3>Monthly Sales</h3>
        <canvas id="monthlySalesChart" style="width: 50%; height: 400px;"></canvas>
    </div>
</div>
    ...
    <script>
        ...
        const salesByProductData = <?= json_encode($data) ?>;
        new Chart(salesByProductCtx, {
            type: 'pie',
            data: {
                labels: salesByProductData.map(d => d.product_name),
                datasets: [{
                    data: salesByProductData.map(d => d.total_qty),
